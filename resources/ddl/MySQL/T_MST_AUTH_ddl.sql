...
--
-- Table structure for table `t_mst_auth`
--

DROP TABLE IF EXISTS `t_mst_auth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_mst_auth` (
  ...
  PRIMARY KEY (`USER_ID`,`EXPIRATION_START`)
...
-- Dump completed on 2022-06-28 10:11:03
